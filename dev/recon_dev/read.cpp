...
//******* input parameter *********
  ...
  #define H 0.6726                     //  (double)
        ...
        // index_sc = 1; sc = 1.052
                                   { 67287.0,    //  00-0 for z = 0.5
                                     67360.0,    //  00-1 for z = 0.5
                                     67142.0,    //  00-2 for z = 0.5
                                     67103.0,    //  00-3 for z = 0.5
                                     67224.0,    //  00-4 for z = 0.5
                                     67062.0,    //  00-5 for z = 0.5
                                     66808.0,    //  00-6 for z = 0.5
                                     67450.0,    //  00-7 for z = 0.5
                                     67327.0,    //  00-8 for z = 0.5
                                     66945.0,    //  00-9 for z = 0.5
                                     67490.0,    //  00-10 for z = 0.5
                                     67642.0,    //  00-11 for z = 0.5
                                     67136.0,    //  00-12 for z = 0.5
                                     67411.0,    //  00-13 for z = 0.5
                                     67181.0,    //  00-14 for z = 0.5
                                     67639.0     //  00-15 for z = 0.5
                                   },
        // index_sc = 2; sc = 0.940
                                   { 4044929.0,    //  00-0 for z = 0.5
                                     4044929.0,    //  00-1 for z = 0.5
                                     4047397.0,    //  00-2 for z = 0.5
                                     4040926.0,    //  00-3 for z = 0.5
                                     4043210.0,    //  00-4 for z = 0.5
                                     4041149.0,    //  00-5 for z = 0.5
                                     4044772.0,    //  00-6 for z = 0.5
                                     4043396.0,    //  00-7 for z = 0.5
                                     4044516.0,    //  00-8 for z = 0.5
                                     4045793.0,    //  00-9 for z = 0.5
                                     4044824.0,    //  00-10 for z = 0.5
                                     4045183.0,    //  00-11 for z = 0.5
                                     4043184.0,    //  00-12 for z = 0.5
                                     4043752.0,    //  00-13 for z = 0.5
                                     4044964.0,    //  00-14 for z = 0.5
                                     4046147.0     //  00-15 for z = 0.5
                                   }
                                 };
    ...
    #endif
  #else
    #define total_par_ori 2985984000.0  //  (double) (= 1440^3) "full"samples
    #define posmin_ori -0.5        //  (double)  [BoxSize]    (not be padded)
    #define posmax_ori 0.5
  #endif
...
//   #ifndef INITIAL
//     #ifdef HALO // halo
//       //#define total_par_ori 59961582.0     //  (double) for z = 0.5
//       #define total_par_ori 57246751.0     //  (double) for z = 1.0
//     #else // matter
//       #define total_par_ori 3276920257.0   //  (double)  10% (from 3200^3) (corresponding to tot_D)
//             // this number is not known originally, so we need to run Data part only to get tot_D
//     #endif
//   #else
//       #define total_par_ori 32768000000.0  //  (double) (= 3200^3) "full"samples
//   #endif
...
//   #ifdef HALO
//   //#define total_par_ori 77395569.0     //  (double) for m001 all
//     //#define total_par_ori 4950185.0    //  (double) for m001, CutSize 1600
//       //#define total_par_ori 4257538.0  //  (double) for m001, CutSize 1600, M_cut 12.5
//       //#define total_par_ori 1337601.0  //  (double) for m001, CutSize 1600, M_cut 13
//       //#define total_par_ori 344792.0  //  (double) for m001, CutSize 1600, M_cut 13.5
//       #define total_par_ori 65105.0  //  (double) for m001, CutSize 1600, M_cut 14
//   //#define total_par_ori 77417680.0     //  (double) for m002
//   //#define total_par_ori 77407545.0     //  (double) for m003
//   //#define total_par_ori 77427693.0     //  (double) for m004
//   #endif
//   #define file_number 1              //  (int)  the number of files
...
#define maxcep_ori 250.0       //  (double)  [Mpc/h]

#define power_0 10000.0        //  (double)  [Mpc/h]^3   along with DR12 [Ashley(2016)]
...
typedef struct
{
    double x[3];        // [Mpc/h]
    double w;
} __attribute__((__packed__)) struct_out_x3w; // disables padding
...
int main(int argc, char *argv[])
{
  ...
  // ******* each simulation ********
    ...
    string p_sample_ini = "/ini_" + ind_RtoD + "_" + ind_parc_used
      ...
      string out_path = p_to_me + p_typesim + p_sim + p_z + "/gal" + p_sc;
    #endif
    out_path += p_sample + p_rsd;
    // initial
  ...
  //             string index_rsd_st = "";
  //           #endif
  //           string f_h = "GRAND_HOD" + p_sc + index_rsd_st;
  //           string l_h = "";
  //           num_file = "";
  //         #endif
  //       #endif
