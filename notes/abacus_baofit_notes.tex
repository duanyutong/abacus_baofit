...
\section{Correlation Functions and Covariance Matrix}
	...
	\subsection{Galaxy Pair Counting}
		...
		All counting is done in fine $(s, \mu)$ bins: $s$ bin edges are from 0 to \SI{150}{h \tothe{-1} \mega\parsec} at \SI{1}{h \tothe{-1} \mega\parsec} steps, and $\mu=\cos\theta$ bin edges are from 0 to 1 at 0.01 steps, meaning a total of $(150, 100)$ bins.
