...
class baofit3D_ellFull_1cov:
    def __init__(self,dv,ic,mod,rl,polydeg):
        ...
        mf0 = open('BAOtemplates/'+mod+'-xi_0.txt').readlines()
        mf2 = open('BAOtemplates/'+mod+'-xi_2.txt').readlines()
        mf4 = open('BAOtemplates/'+mod+'-xi_4.txt').readlines()
...
# def baofit():
    try:
        ...
        alrm, altm, chim = Xism_arat_1C_an(
            ...
            armin=0.986, armax=1.030, spar=0.0008,  # armin=0.910, armax=1.010, spar=0.0015,
            atmin=0.996, atmax=1.014, spat=0.0008)  # atmin=0.990, atmax=1.040, spat=0.0015)
